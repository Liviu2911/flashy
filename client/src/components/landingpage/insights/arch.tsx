  ...
  return (
    <div className="relative w-full">
      <div className="w-full h-24 overflow-hidden flex absolute justify-center">
        ...
        <div className="relative z-30 bg-gradient-to-r from-black to-transparent w-48 h-36" />
        <div className="relative ml-[720px] z-30 bg-gradient-to-r from-transparent to-black w-48 h-36" />
      </div>
